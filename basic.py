...
####################################
    ...
    def atom(self):
        ...
        return res.failure(InvalidSyntaxError(tok.pos_start, tok.pos_end, "Expected 'IF', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '[' or '('"))
    ...
    def call(self):
        ...
        if self.current_tok.type == TT_LPAREN:
            ...
            if self.current_tok.type == TT_RPAREN:
                ...
                if res.error: return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, f"Expected ')', 'VAR', 'NOT', 'IF', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '('"))
    ...
    def list_expr(self):
        ...
        if self.current_tok.type == TT_RSQUARE:
            ...
            if res.error: return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, f"Expected ']', 'VAR', 'NOT', 'IF', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '(' or '['"))
    ...
    def expr(self):
        ...
        if res.error: return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, "Expected 'VAR', 'IF', 'FOR', 'WHILE', 'FUN', 'NOT', int, float, identifier, '+', '-', '[' or '('"))
    ...
    def while_expr(self):
        ...
        if not self.current_tok.matches(TT_KEYWORD, 'THEN'):
            return res.failed(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, f"Expected 'THEN'"))
    ...
    def subbed_by(self, other):
        if isinstance(other, Number):
            ...
            try:
                ...
                return None, RTError(other.pos_start, other.pos_end, f"Element at this index could not be removed from list - index out of bounds", self.context)
        else:
            return None, Value.illegal_operation(self, other)
    ...
    def dived_by(self, other):
        if isinstance(other, Number):
            try:
                ...
                return None, RTError(other.pos_start, other.pos_end, f"Element at this index could not be retrieved from list - index out of bounds", self.context)
        else:
            return None, Value.illegal_operation(self, other)
...
class BaseFunction(Value):
    ...
    def check_args(self, arg_names, args):
        ...
        if len(args) > len(arg_names):
            return res.failure(RTError(self.pos_start, self.pos_end, f"Too many args passed into '{self.name}' ({len(args) - len(arg_names)})", self.context))
        
        if len(args) < len(arg_names):
            return res.failure(RTError(self.pos_start, self.pos_end, f"Too few args passed into '{self.name}' ({len(arg_names) - len(args)})", self.context))
...
####################################
    ...
    def execute_append(self, exec_ctx):
        ...
        if not isinstance(list_, List):
            return RTResult().failure(RTError(self.pos_start, self.pos_end, f"First argument must be of type LIST", exec_ctx))
    ...
    def execute_pop(self, exec_ctx):
        ...
        if not isinstance(index, Number):
            return RTResult().failure(RTError(self.pos_start, self.pos_end, f"Second argument must be of type NUMBER", exec_ctx))
        
        try:
            element = list_.elements.pop(index.value)
        except:
            return RTResult().failure(RTError(self.pos_start, self.pos_end, f"Element at this index could not be removed from list - index out of bounds", exec_ctx))
    ...
    def execute_extend(self, exec_ctx):
        ...
        if not isinstance(listB, Number):
            return RTResult().failure(RTError(self.pos_start, self.pos_end, f"Second argument must be of type LIST", exec_ctx))
        
        listA.elements.extend(listB.elements)
        return RTResult().success(Number.null)
    execute_append.arg_names = ['listA', 'listB']
...
####################################
    ...
    def visit_BinOpNode(self, node, context):
        ...
        elif node.op_tok.type == (TT_KEYWORD, 'AND'):
